...
<html lang="pt-br">
    <head>
		...
		<script async src="https://www.googletagmanager.com/gtag/js?id=UA-129351427-1"></script>
		<script>
    ...
    <body>
        ...
        <ul class="rslides" id="slider">
            <li><img src="./img/polarys.jpg" ALT="Power Estética POLARYS" TITLE="Power Estética POLARYS" /></li>
            <li><img src="./img/hooke.jpg" ALT="Power Estética HOOKE" TITLE="Power Estética HOOKE"  /></li>
            <li><img src="./img/lyra.jpg"  ALT="Power Estética LYRA" TITLE="Power Estética LYRA"  /></li>
        </ul>
        <div id="tudo">
            <div id="geral" class="geral_tudo">                    
                <div id="conteudo">
                    ...
                    <div id="equipamento">
                        ...
                        <div style="background-color: #DDD;margin-bottom: 8px;" >
							<div class="imagem">
								<img src="img/polarysm.png" ALT="Power Estética POLARYS" TITLE="Power Estética POLARYS" />
							</div>						
							<div class="produto">
                        ...
                        <div style="background-color: #CDD;margin-bottom: 8px;">                            
							<div class="imagem">
								<img src="img/hookem.png" ALT="Power Estética HOOKE" TITLE="Power Estética HOOKE"  />
							</div>
							...
							<div class="produto" id="hooke">
								<div class="tit_prod">Hooke</div>
									...
									Radiofrequência
									<p>
										A radiofrequência é o tratamento mais indicado para o tratamento de flacidez da pele e 
                        ...
                        <div style="background-color: #CEF;">
							<div class="imagem">
								<img src="img/lyram.png" ALT="Power Estetica Lyra" TITLE="Power Estetica Lyra" />
							</div>
                ...
                <div id="contato">
                    ...
                    <div id="rede_social">
                        ...
                        <BR><BR><BR>
                        <label>
                            <img src="./img/tel.png" style="width: 40px;" ALT="Power Estetica" TITLE="Power Estetica What'sapp" /> &nbsp; &nbsp;
                            (11) 94996-1207
                        </label>
                        <BR><BR>
                        <label>
                            <img src="./img/email.jpg" style="width: 40px;" ALT="Power Estetica" TITLE="Power Estetica Email"  /> &nbsp; &nbsp;
                            contato@powerestetica.com.br                               
                        </label>
                        <BR><BR>
                        <label>
                            <a href="https://www.facebook.com/powerestetica" target="_blank" ALT="Power Estetica" TITLE="Power Estetica facebook.com/powerestetica">
                                <img src="./img/facebook.jpg" style="width: 40px; "  ALT="Power Estetica" TITLE="Power Estetica facebook.com/powerestetica" /> &nbsp; &nbsp;
                ...
                <div id="rodape">
                        <a href="#" title="Power Estética HOME" onclick="rolar_para('#tudo_topo')">Home</a> |
                        <a href="#" title="Power Estética PRODUTOS" onclick="rolar_para('#tit_equipamento')">Produto</a> |
                        <a href="#" title="Power Estética CONTATO" onclick="rolar_para('#contato')">Contato</a>  
                </div> 
            </div>        
        </div>  
    </body>
